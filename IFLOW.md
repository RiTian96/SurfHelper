...
| **JavDB影片管理器** | 1.6.0 | `https://javdb.com/*` | 已看/想看影片屏蔽，评分高亮，批量管理，欧美区番号支持，番号标准化存储，手动数据去重，前缀去重，大图预览 |
...
- **VIP视频解析器**: 多平台VIP内容解析，支持自动切换接口

#### 🛡️ 内容管理类
- **JavDB影片管理器**: 智能屏蔽已看/想看影片，评分高亮过滤，批量导入管理，欧美区番号支持，番号标准化存储防重复，手动数据去重，前缀去重清理不完整番号，鼠标悬停大图预览
