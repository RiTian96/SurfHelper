...
### 🌟 评分高亮系统
- **必看影片** - 4.5 分以上影片显示金色"必看"标记，带脉冲动画效果
- **推荐影片** - 4.0-4.5 分影片显示绿色"推荐"标记
- **智能过滤** - 10 人以下评价正常显示，10 人以上按分数分级处理
- **分级规则** - 0-3.5分屏蔽，3.5-4.0分正常，4.0-4.5分推荐，4.5分以上必看
- **统一开关控制** - 评分过滤和高分高亮共用同一个开关，简化操作
